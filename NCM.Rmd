...
stargazer(acre.rob, acre.bean, acre.stove, acre.solar, type = "html", omit="District", covariate.labels = c("Treatment", "OAF Seasons"), dep.var.labels = c("Maize acres", "Beans", "Stove", "Solar")) 
...
stargazer(acre.maizchoice, type = "html", omit="District", covariate.labels = c("Treatment", "OAF Seasons"))
